...
function partThreeB () {
  // 1. prompt for a friend
  let friend = prompt("What is the name of your friend?")
  // 2. add the friend to the message
  messageParagraph.innerHTML += `, ${friend}`;
}
...
function partFourB () {
  ...
  newFavFlavor = prompt(`You have ${totalFavFlavors} favorite flavors of ice cream. To add another, enter an ice cream flavor.`);
